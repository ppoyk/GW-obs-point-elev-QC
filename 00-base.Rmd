...
```{r KM2-lataaminen-ja-lukeminen, message=FALSE, include=FALSE}
...
for (i in 1:nrow(putki_yhd_temp)) {
  # Check that type is NOT monitoring pipe (incl. some mstre meters) or well
...
# TODO drop asemat joissa epäilyttäviä linkityksiä
